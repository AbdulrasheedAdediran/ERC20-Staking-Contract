...
const interestInPercent = 10;
  ...
  const StakingContractAddress = "0x26B862f640357268Bd2d9E95bc81553a2Aa81D7E"
  ...
  // Staking Contract Address: 0x26B862f640357268Bd2d9E95bc81553a2Aa81D7E
  ...
  console.log(`Pranked User's Stake History: ${await StakingContract.connect(signer).viewStakeHistory()}`);
  
  console.log(`Pranked user's Stake Balance: ${await StakingContract.connect(signer).viewStakeBalance()}`)
  
  await ethers.provider.send("evm_increaseTime", [600]); 
  // await network.provider.send("evm_mine", [600]);
  
  console.log(`Withdrawing 200000: ${await StakingContract.connect(signer).withdraw(200000)}`);
